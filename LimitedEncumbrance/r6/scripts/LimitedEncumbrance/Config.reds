public class LimitedEncumbranceConfig {
  ...
  @runtimeProperty("ModSettings.description", "Overrides the Limited Carry Capacity system with a fixed value and aloows only bags as modifiers (use 0 to turn OFF)")
  ...
  @runtimeProperty("ModSettings.description", "Sets the maximum value assigned to the carry capacity for both Manual and Dynamic systems (in total value)")
  @runtimeProperty("ModSettings.step", "10")
